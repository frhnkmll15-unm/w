package com.juaracoding.mfkspringbootjpa.core;

import com.juaracoding.mfkspringbootjpa.configuration.ConfigProperties;
...
public class SMTPCore {
    ...
    public StringBuilder getsBuild() {
        return sBuild;
    }

    public void setsBuild(StringBuilder sBuild) {
        this.sBuild = sBuild;
    }
